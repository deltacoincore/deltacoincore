...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " deltacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  deltacoin-tx [options] <hex-tx> [commands]  Update hex-encoded deltacoin transaction\n" +
            "or:     deltacoin-tx [options] -create [commands]   Create hex-encoded deltacoin transaction\n" +
            "\n";

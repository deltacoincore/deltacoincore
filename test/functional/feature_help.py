...
"""Verify that starting deltacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deltacoin with -h for help text")
        ...
        self.log.info("Start deltacoin with -version for version information")
        ...
        self.log.info("Start deltacoind with -fakearg to make sure it does not start")

...
bech32_templates = [
  ...
  ('deco',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('deco',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('deco',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tdeco',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tdeco',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tdeco',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rdeco',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rdeco',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rdeco', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tdeco',  17, 32, False, False, False),
  ('rdeco',  3,  1, False, False, False),
  ('deco',   15, 41, False, False, False),
  ('tdeco',  0, 16, False, False, False),
  ('rdeco',  0, 32, True,  False, False),
  ('deco',   0, 16, True,  False, False),
  ('tdeco',  0, 32, False, True,  False),
  ('rdeco',  0, 20, False, False, True)
]

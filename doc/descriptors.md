# Support for Output Descriptors in Deltacoin Core

Since Deltacoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `deco1...` for mainnet or `tdeco1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Deltacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Deltacoin Core wallets, a convenience function `combo` is
